...
# ==================================================
    def login(self):
        """
        ورود/ ثبت نام کاربر یا ادمین 
        ورود به بخش ادمین یا کاربر
        """
...
# ============================================================
                ...
                """نمایش تمام کتاب های موجود"""
                self.library.show_books()
# ============================================================
            elif choice == "3":
                """جستجوی کتاب با چند آی دی"""
